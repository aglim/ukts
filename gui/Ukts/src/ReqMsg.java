 ...
 * This class implements a Java interface to the 'ReqMsg'
 * message type.
 */

public class ReqMsg extends net.tinyos.message.Message {
    ...
    /** Create a new ReqMsg of size 14. */
    public ReqMsg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new ReqMsg of the given data_length. */
    public ReqMsg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new ReqMsg with the given data_length
     * and base offset.
     */
    public ReqMsg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new ReqMsg using the given byte array
     * as backing store.
     */
    public ReqMsg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public ReqMsg(byte[] data, int base_offset) {
     ...
     */
    public ReqMsg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new ReqMsg embedded in the given message
     * at the given base offset.
     */
    public ReqMsg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public ReqMsg(net.tinyos.message.Message msg, int base_offset, int data_length) {
